    ...
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="max-w-4xl mx-auto text-5xl font-medium tracking-tight font-display text-slate-900 sm:text-7xl">
        ...
        <span className="relative text-blue-600 whitespace-nowrap">
          ...
          <span className="relative text-pine">Multichannel SaaS</span>
        </span>{' '}
        
      </h1>
      <p className="max-w-2xl mx-auto mt-6 text-lg tracking-tight text-slate-700">
        Hello Pine verbindet Dich mit einer großen Auswahl an Plattformen und führenden Marktplätzen <br/> - ganz einfach, in nur wenigen Klicks.
      </p>
        ...
        >
          {[
            ...
            <li key={groupIndex}>
              <ul
                role="list"
                className="flex flex-col items-center gap-y-8 h-24 sm:flex-row sm:gap-x-12 sm:gap-y-0"
              >
                {group.map((company) => (
                  <li key={company.name} className="flex flex-1 object-cover h-full">
